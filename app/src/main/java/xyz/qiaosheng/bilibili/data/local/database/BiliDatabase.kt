...
@Database(entities = [SearchHistoryEntity::class, LibraryEntryEntity::class, FavoriteFolderEntity::class,
    LibraryOutboxEntity::class, WatchProgressEntity::class], version = 2, exportSchema = false)
    ...
    companion object {
        ...
        val MIGRATION_1_2 = object : Migration(1, 2) {
            override fun migrate(db: SupportSQLiteDatabase) {
                ...
                db.execSQL("""CREATE TABLE IF NOT EXISTS library_outbox (
                    accountId INTEGER NOT NULL, kind TEXT NOT NULL, folderId INTEGER NOT NULL,
